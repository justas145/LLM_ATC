'''
    ...
    PYTHONPATH=C:\\Users\\justa\\OneDrive\\Desktop\\Developer\\Thesis_ATM_with_LLM\\bluesky python textclient.py
'''

import sys
sys.path.append(
    'C:\\Users\\justa\\OneDrive\\Desktop\\Developer\\Thesis_ATM_with_LLM\\bluesky')
try:
